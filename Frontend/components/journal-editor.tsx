...
interface JournalEditorProps {
  onSave: (content: string, emotion: EmotionKey, aiReview: string, isAnonymous: boolean) => void
}
  ...
  return (
    <div className="h-full mt-2 flex flex-col bg-white">
      <div className="px-6 py-2 bg-white border-b flex-shrink-0">
        <h2 className="text-lg font-semibold text-foreground mb-0">Today's Journal</h2>
                ...
                {currentEmotion && (
                  ...
                  >
                    <div className="flex items-center gap-3 p-4 rounded-lg bg-gray-50 border">
                      <span className="text-4xl">{emotions[currentEmotion].emoji}</span>
                      <div>
                        <p className="text-xs text-muted-foreground font-medium mb-1">Detected Emotion</p>
                      ...
                      <CardContent className="p-4">
                        <div className="flex items-start gap-3">
                          ...
                          <div className="flex-1">
                            <p className="font-semibold text-foreground mb-2 text-sm">AI Empathetic Response</p>
                            <p className="text-xs text-foreground/80 leading-relaxed">{aiReview}</p>
                          </div>
                        </div>
                      </CardContent>
                    </Card>
